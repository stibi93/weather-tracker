...
- **THEN** a magyarázó változónkénti korrelációk a napi szintváltozáson alapulnak, és minden
  magyarázó változóhoz tartozik
...
szórásdiagramját (illesztett vonallal és R²-tel), a magyarázó változónkénti korrelációs táblát
(késleltetés
